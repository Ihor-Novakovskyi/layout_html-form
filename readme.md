...
- [DEMO LINK](https://Ihor-Novakovskyi.github.io/layout_html-form/)
- [TEST REPORT LINK](https://Ihor-Novakovskyi.github.io/layout_html-form/report/html_report/)
...
- The email field should have placeholder value: `@exampleemail.com`.
